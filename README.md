...
Author: Dr. Marie Davidian - NC State Statistics Professor
...
Update your LaTeX Environment/Packages:
 * Windows: Open MiKTeX Console
 * Mac: Open Applications/TeX/Tex Live Utility
 * GUI editor environments change BUILD to use lualatex
