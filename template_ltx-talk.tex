...
\begin{frame}
  ...
  \begin{center}
    ...
    \vspace{0.1in}
    \includegraphics[height=3cm,alt={NC State Department of Statistics
    logo}]{images/wolf.jpg}
    \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=2.2in,alt={True probability density of
      ...
      skewed, with a right tail of high incomes}]{images/incomedensity.png}
    \end{center}
\vspace*{-0.15in}
    \begin{itemize}
 ...
 \phantomsection\label{slide:surveypics}
  ...
  \begin{center}
    \includegraphics[width=2.15in,alt={Histogram of income data from
      ...
      superimposed}]{images/incomefulldata.png} \hspace{0.05in}
      \includegraphics[width=2.15in,alt={Histogram of income data from
        the actual survey, with the true density and a normal density
      with the same mean and standard deviation
      superimposed}]{images/incomeobsdata.png}
\end{center}
...
\begin{center}
  ...
  \includegraphics[width=3.25in,alt={Plot of mean income over time,
    ...
    distributions of income at each of several time points}]{images/dropout_full.png}
...
\includegraphics[width=2.15in,alt={Normal density of incomes at
  ...
  mean shaded in blue}]{images/dropout_norm.png} \hspace{0.05in}
\includegraphics[width=2.15in,alt={Apparent density of the incomes for
  individuals who did not dropout, which is left-skewed}]{images/dropout_skew.png}
\end{center}
...
\includegraphics[width=2.25in,alt={Solid blue line showing the true mean
  ...
  mean outcome from the observed data}]{images/dropout_both.png}
\end{center}
  ...
  \begin{frame}
    ...
    \begin{center}
      \includegraphics[width=3.1in,alt={Longitudinal outcomes for
        ...
        carried forward to the future time points}]{images/locf.png}
      \end{center}
